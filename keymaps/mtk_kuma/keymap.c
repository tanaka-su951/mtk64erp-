...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [5] = {ENCODER_CCW_CW(KC_LEFT  , KC_RGHT) , ENCODER_CCW_CW(KC_UP   , KC_DOWN  )},
    [6] = {ENCODER_CCW_CW(KC_LEFT  , KC_RGHT) , ENCODER_CCW_CW(KC_UP   , KC_DOWN  )},
    [7] = {ENCODER_CCW_CW(KC_LEFT  , KC_RGHT) , ENCODER_CCW_CW(KC_UP   , KC_DOWN  )},
};
#endif
